        ...
        <div className="relative">
          ...
          <div className="absolute -bottom-5 -right-3 hidden rounded-2xl bg-white px-4 py-3 shadow-lg ring-1 ring-brand-border sm:flex sm:items-center sm:gap-2.5">
            ...
            <div>
              ...
              <p className="text-sm font-black text-foreground">Love & Care</p>
            </div>
          </div>
        ...
        <div>
          ...
          <div className="mt-6 grid grid-cols-2 gap-3">
            <div className="rounded-2xl bg-brand-light-bg p-4 ring-1 ring-brand-border">
              <p className="text-2xl font-black text-brand-red">2024</p>
              <p className="text-xs font-medium text-muted-foreground">Founded</p>
            </div>
            <div className="rounded-2xl bg-brand-light-bg p-4 ring-1 ring-brand-border">
              <p className="text-2xl font-black text-brand-red">100%</p>
              <p className="text-xs font-medium text-muted-foreground">Verified Stores</p>
            </div>
          </div>
        </div>
      </div>
